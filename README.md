...
3. Call the carousel function and configure the options:
	...
	```
## Browser support
Since the code relies on the classlist API it won’t work on anything that doesn’t support it (e.g. IE8 and IE9). Check http://caniuse.com/#search=classlist for more details. It was tested on Chrome, Safari, Opera (new and 12), IE10, iOS Safari and Chrome for Android.
